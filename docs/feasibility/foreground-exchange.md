...
Each physical attempt must record the direction, payload size, adapter and strategy, permission/radio state, lifecycle timing, expected and received SHA-256 values, and a structured failure reason. Do not record message contents, private keys, personal routes, or raw contact exports.
